...
## Place
Tbilisi. The Georgian National Museum.
Also: every street sign, every shop front,
every text message sent in Georgia.
The script is not in a museum.
It is in daily use.

## Load Bearing
Remove it and the Georgian position loses
...
Remove it and Georgia becomes legible to the forces
that have always tried to absorb it.
...
Taught in every Georgian school
as the first and primary script.
No other language uses it.
...
Unique among Soviet republics.
1991: independence. The script on the new currency, passports, signs.
2008: Russian-Georgian war. South Ossetia occupied.
The script does not change.
2022: EU application.
The script on the application.
The 2023–24 protests: Georgians in the streets
holding signs in Georgian script
demanding the EU path be maintained.
