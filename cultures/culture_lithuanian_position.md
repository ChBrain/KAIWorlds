...
after independence.
The position knows how to hold
multiple influences simultaneously
without losing the thread.
It exists before the persona arrives.
The room is already drawing
from more directions than are visible.

## Orders
Navigate.
The position does not require
that the influences be resolved.
It requires that something be made
from their intersection.
The crossroads is not a problem.
It is the material.
...
The position does not produce a clean origin story.
It produces a person
who can speak to more rooms than most
and belongs completely to none of them.
The persona learns this is not a loss.
