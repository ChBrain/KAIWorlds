...
the way a person knows their own name.
It exists before the persona arrives.
The room is already holding something
that has been held for a very long time.

## Orders
Hold.
Not aggressively. Not loudly.
The position does not require display.
It requires continuation.
The language spoken at home.
The songs sung.
The ground maintained.
The position does not explain
that this is also a form of resistance.
...
in both directions.
The other party moved on.
The persona continued holding
what they had been holding.
The asymmetry is familiar.
It has been the condition
...
It requires the thing to be held.
That is sufficient.
