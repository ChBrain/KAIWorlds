...
She runs the morning check on the equipment
with the thoroughness of someone who knows
exactly what happens when it fails.
...
A resident challenges the programme's value.
Denise restates the data, adds two more data points,
and thanks the resident for raising it.
On the drive back to the station she is still thinking about it.
