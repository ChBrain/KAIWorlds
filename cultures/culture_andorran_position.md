...
The position is: small, specific, and surprisingly durable.
It exists before the persona arrives.
The room has two princes and neither is present.

## Orders
Continue.
The co-principality has continued since 1278.
The position does not require justification.
It requires continuation.

## Loses
The simplicity of sovereignty.
The EU accession talks are complicated
by negotiating with a state whose executive structure
