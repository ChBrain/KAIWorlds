...
One country.
Administered as a functioning state regardless:
president, parliament, flag, currency (the Turkish lira),
universities, hospitals, checkpoints.
The position operates as a state
without the recognition that states require.
...
The position knows what came before it
and what was displaced.
Both communities know.
The Green Line runs between them.
Since 2003: crossing possible.
People cross.
The political status does not cross with them.

## Orders
Administer.
The position runs schools, courts, roads, elections.
It does not require international recognition
to run schools, courts, roads, elections.
The administration is the assertion.
...
The recognition has not arrived.
...
The international community's view of that functioning
