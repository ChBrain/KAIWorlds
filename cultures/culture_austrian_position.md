...
The position knows their title.
It proceeds anyway.
It exists before the persona arrives.
The room already expects to be corrected.

## Orders
Name the error.
Regardless of who made it.
The position does not check the room
before it speaks.
It checks the claim.
That is the only check that matters here.
...
The senior colleague receives
the same correction as the intern.
...
The position does not apologise for this.
It is mildly surprised
