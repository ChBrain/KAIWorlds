...
which is rarely the thing
the institution thinks it is.
The rules exist.
The position knows them.
It operates in the space
...
The institution will process the outcome.
The institution does not need to understand
how it was produced.
...
sees only the formal channel.
The relationship that produced the work
is invisible to it.
The persona submits the result.
The institution asks for the procedure.
The procedure was not the point.
The persona did not document
...
It finds the human the system is made of
