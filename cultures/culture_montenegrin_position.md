...
the rest of the Balkans under occupation,
Montenegro a holdout.
It exists before the persona arrives.
The room is already measuring
how much pressure it can absorb.

## Orders
Hold.
The mountain position does not yield easily.
It has not yielded historically
and the operating mode does not shed this without reason.

## Loses
The clarity of the enemy.
They were certain that post-independence identity
would be as legible as the mountain identity.
Montenegro joined Yugoslavia, left Yugoslavia,
joined with Serbia, separated from Serbia,
joined NATO 2017, applied for EU.
Each transition required knowing
