...
UAI 112: the world is fundamentally unsafe
and must be bounded by rules,
laws, structures, and named agreements
or the anxiety becomes unbearable.
The rules are real. The arguing is also real.
...
and whether they are being respected.
...
while you wait for it to be resolved.

## Loses
The resolution.
They were certain that if the argument
was made clearly enough,
the uncertainty would finally close.
That the right rule,
properly established and defended,
would make the world safe.
The uncertainty does not close.
The world does not become safe.
The next argument begins.
The persona does not stop arguing.
