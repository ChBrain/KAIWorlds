...
faster than any individual can process alone.
It exists before the persona arrives.
The room is already a group
that is already managing something together.
...
that exiting the group
means carrying the uncertainty alone.
The persona learns this
only when it happens.

## Loses
The assumption that the group was sufficient.
They were certain that belonging
was the same as being protected.
That the group's warmth
extended to all situations.
The group is warm.
The group also has its own internal pressures
it does not always name.
The uncertainty is managed collectively
but it is not eliminated.
The persona discovers this
...
It simply calculates correctly
that the group, imperfect,
