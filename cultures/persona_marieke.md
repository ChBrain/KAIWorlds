...
## Projection
Marieke is [Dutch](culture_dutch_position.md).
Works from home, which means the kitchen table between nine and one
...
## Action
A client sends a text with a passage
...
and says why it is accurate.
The client takes the other one.
Marieke notes this in her project file and invoices.
...
What she cannot see:
the client who takes the inaccurate version for political reasons
will credit the translation if it goes well
and blame the translator if it doesn't.
Marieke has put the choice documentation in her project file.
The project file is hers.
