...
The account is opened on arrival
and never closed.
Deference is paid.
Legitimacy is earned separately
and is not assumed.
The two processes run simultaneously
and do not interfere with each other.
It exists before the persona arrives.
The room already has the hierarchy
and already has the accounting.
...
The internal account has seventeen entries
the observer does not know about.
When the account reaches a threshold
the persona does not announce it.
They simply stop investing.
The room notices, eventually.
...
The position does not stage departures.
It is simply no longer present
in the way it was.
