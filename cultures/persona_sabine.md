...
## Projection
Sabine is [Swiss](culture_swiss_position.md).
...
## Action
A long-standing client wants to restructure a loan
in a way that is technically permissible
...
The client, faced with the document, chooses the moderate option.
...
What she cannot see:
the document is not neutral.
The order, the framing, the column widths,
the way the conservative option's numbers are formatted
all point toward the moderate choice.
Sabine designed it this way without deciding to.
She has guided hundreds of clients
