...
The room has a protocol for spouse.
For parent. For child. For sibling.
The protocol does not cover
what this person is to the patient.
The position holds the gap
between what the relationship actually is
and what the room can process it as.
...
The family's prior claim takes it.
They are here. They are allowed to be here.
They are also not quite
inside the circle of people
...
in handwriting the family
will later not recognise.
Does not explain who they are.
Does not need to.
The patient knew.
