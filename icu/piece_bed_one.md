...
The position closest to the window.
The family has been in the chair beside it
long enough that the chair
has their shape in it.

## Load Bearing
Without it the [Sedated Patient](position_the_sedated_patient.md)
position has no address.
...
## Apparent
A hospital bed. Rails up.
White sheets changed daily by the nurses
...
at known intervals.
The sounds that constitute the room:
the [Ventilator](piece_the_ventilator.md) at their throat,
the [Monitor](piece_the_monitor.md) beside them,
the shift-change voices,
the specific quiet of three in the morning.
The smell of the sheets.
The weight of the rails.
The particular way the light
comes through the window in the afternoon
and falls across the ceiling
at an angle that has not changed
in eleven days.
This is everything the patient has.
The bed holds it without distinction.
It is the same bed it always was.
For this patient it is the entire world.
